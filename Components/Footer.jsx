  ...
  return (
    <>
      <div className="bg-gradient-to-b from-purple-100 to-white py-12 flex items-center justify-between">
        <div className="">
          <h2 className="text-4xl font-bold text-orange-400 ml-5">ShopEase</h2>
      ...
      <div className="">
        <p className="text-sm text-black ml-5 mt-2 text-center">&copy; {new Date().getFullYear()} ShopEase. All rights reserved.</p>
      </div>
    </>
  );
};
