      ...
      <div className="flex flex-col flex-1 ml-10 w-full md:w-1/2">
        ...
        <div className="flex flex-col gap-4 w-full md:w-3/4 my-5">
          ...
          <div className="flex flex-row gap-4">
            ...
            >
              Whether you're exploring the latest in fashion and beauty, upgrading your tech arsenal with cutting-edge gadgets, enhancing your home with stylish decor and appliances, or seeking thoughtful gifts for loved ones, ShOpEase Online has you covered. Our curated selection ensures quality and variety, featuring trusted brands and innovative products that meet high standards of performance and style. 
            </button>
            <button
              className={`${
